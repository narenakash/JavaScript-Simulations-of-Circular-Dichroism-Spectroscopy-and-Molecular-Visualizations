...
var x2=1;
  ...
  viewer.addSphere({ center: c1, radius: 0.4, color: 'skyblue',
...
incorrecto();
  ...
  viewer.addCylinder({ start: c1, end: o2,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: c1, end: h1,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: c2, end: c4,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: c2, end: h2,radius: .13,color:'white',radiusRadio:0.1,});
  ...
  viewer.addCylinder({ start: c3, end: h5,radius: .13,color:'white',radiusRadio:0.1,});
  ...
  viewer.addCylinder({ start: c4, end: h7,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: o3, end: c5,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: c5, end: c6,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: c5, end: o1,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: o3, end: c9,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: o2, end: h8,radius: .13,color:'white',radiusRadio:0.1,});
  ...
  viewer.addCylinder({ start: c6, end: h01,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: c7, end: c8,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: c7, end: h03,radius: .13,color:'white',radiusRadio:0.1,});
  ...
  viewer.addCylinder({ start: c8, end: h05,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start:c9, end: h06,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start:c9, end: h07,radius: .13,color:'white',radiusRadio:0.1,});
