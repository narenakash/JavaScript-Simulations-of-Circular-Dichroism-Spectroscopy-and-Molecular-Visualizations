...
$(function() {
  ...
  viewer1.addLabel("Carbon", {position: {x:-0.5 , y:2.5, z:5}, backgroundColor: 'skyblue',backgroundOpacity: 0.9,fontSize: 13});
  viewer1.addLabel("Oxygen", {position: {x:-0.5, y:1.8, z:5}, backgroundColor: 'red',backgroundOpacity: 0.8,fontSize: 13});
  viewer1.addLabel("Hydrogen", {position: {x:-0.5 , y:1.1, z:5}, backgroundColor: 'silver',backgroundOpacity: 0.8,fontSize: 13});
  ...
  viewer1.addCylinder({ start: {x:-0.380 , y:-3.95 , z:-2.930}, end: {x:-0.38 , y:-4.6 , z:-3.951},radius: .08,color:'white',radiusRadio:0.1,});
  viewer1.addCylinder({ start: {x:-0.380 , y:-4.3 , z:-3.1}, end: {x:-0.38 , y:-4.95 , z:-4.1},radius: .08,color:'white',radiusRadio:0.1,});
  ...
  viewer1.addCylinder({ start: c5, end: c9,radius: .13,color:'white',radiusRadio:0.1,});
  ...
  viewer1.addCylinder({ start: o2, end: c6,radius: .13,color:'white',radiusRadio:0.1,});
  // viewer1.addCylinder({ start: o3, end: c8,radius: .13,color:'white',radiusRadio:0.1,});
  ...
  viewer1.addCylinder({ start: c7, end: c01,radius: .13,color:'white',radiusRadio:0.1,});
  ...
  viewer1.addCylinder({ start: c8, end: h01,radius: .13,color:'white',radiusRadio:0.1,});
