...
incorrecto();
  ...
  viewer.addCylinder({ start: c2, end: o3,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: c2, end: c8,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: c3, end: c4,radius: .13,color:'white',radiusRadio:0.1,});
  viewer.addCylinder({ start: c3, end: o2,radius: .13,color:'white',radiusRadio:0.1,});
  ...
  viewer.addCylinder({ start: o2, end: h03,radius: .13,color:'white',radiusRadio:0.1,});
  ...
  // viewer.addCylinder({ start: c8, end:c8,radius: .13,color:'white',radiusRadio:0.1,});
